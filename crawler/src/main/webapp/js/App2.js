  ...
  function sortVideos(data2){
    ...
    for (i = 0; i < data2.items.length; i++){
      ...
      if (data2.items[i].statistics.likeCount > 20 && data2.items[i].statistics.dislikeCount < (0.1 * data2.items[i].statistics.likeCount)
        ...
        var viewcounts = item.statistics.viewCount;
        var commentcounts = item.statistics.commentCount;
        var likes = item.statistics.likeCount;
        var dislikes = item.statistics.dislikeCount;
        var url = item.id;
        var obj= new videoInfo (viewcounts,commentcounts,likes, dislikes, url);
        //Newly added line by steven 
